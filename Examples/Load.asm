Main:
    ...
    ldr q r1 r2 ; Load register with quad word from memory address.
    ...
    lda q r1 0050 ; Load register with quad word from memory address.

    ldi b r1 0 ; Load register with byte from imediate value.
    ldi h r1 0 ; Load register with half from imediate value.
    ldi w r1 0 ; Load register with word from imediate value.
    ldi d r1 0 ; Load register with double word from imediate value.
    ldi q r1 0 ; Load register with quad word from imediate value.
